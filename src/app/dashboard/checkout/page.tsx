...
export default function Checkout(): JSX.Element {
    ...
    return (
        <>
            <div className="flex flex-col items-center gap-4 mt-16 bg-muted">
                <h1 className="text-5xl font-bold h2 w-full px-4 text-center md:w-[805px] md:px-0">
                    Qashboard
                </h1>
                <p className="body-xl w-full px-4 text-center text-slate-11 md:w-[572px] md:px-0 text-2xl">
                    Unlock new possiblilities with AI insights
                </p>
            </div>
                ...
                <div className="flex flex-col items-start gap-6 mx-auto md:flex-row">
                    <div className="flex h-[353px] flex-col gap-8 rounded-lg bg-slate-2 px-6 py-12 border-[3px] border-crimson-6">
                        <div className="flex flex-col gap-2">
                            <h6 className="body-semibold text-slate-12">
                                Hawk Plan
                            </h6>
                        ...
                        <button
                            ...
                            type="button"
                        >
                            Subscribe to Hawk plan
                        </button>
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center gap-3">
                                <svg
                                    className="w-6 h-6 stroke-crimson-9"
                                    viewBox="0 0 24 24"
                                    fill="none"
                                >
                                    <path
