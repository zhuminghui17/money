    ...
    return (
        <div className="relative text-black dark:text-white">
            <Link
                ...
                href="#"
            >
                <span className="hidden text-right dark:text-white lg:block">
            ...
            <div
                ...
                className={`border-stroke shadow-default absolute right-0 mt-1 flex w-48 flex-col rounded-sm border bg-white dark:bg-dark-tremor-background ${
                    dropdownOpen ? "block" : "hidden"
                }`}
            >
                <ul className="flex flex-col gap-5 py-5 border-b border-stroke px-7">
                    <li
